...
artifacts exist. It is derived from the artifacts on disk, including the fields
the provenance manifest records, and never from a status string. Progress is
